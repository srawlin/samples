...
class bittrex(object):
    def __init__(self, APIKey, Secret):
        ...
        self.account_set = set(['getbalances','getbalance','getdepositaddress','withdraw', 'getorderhistory'])
    ...
    def api_query(self, method, req={}):
        ...
        sign = hmac.new(self.Secret, request_url, hashlib.sha512).hexdigest()
        headers = {
             'apisign': sign,
        }
        ret = urllib2.urlopen(urllib2.Request(request_url, None, headers))
    ...
    def get_order_history(self, market=None, count=None):
        ...
        if count:
            req['count'] = count
        return self.api_query('getorderhistory', req)